// Shared quiet-mode state for Maestro tool rendering.
//
// Cockpit owns the config and broadcasts it on cockpit:ui-ownership. Flow and
// teammate mirror both the enable flag and lifecycle glyph set so every
// Maestro-owned tool uses the same Quiet presentation without importing
// Cockpit internals.
