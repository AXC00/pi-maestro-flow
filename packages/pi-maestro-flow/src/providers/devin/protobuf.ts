/**
 * High-performance, zero-builder protobuf wire codecs.
 *
 ...
 *
 * Vendored from oh-my-pi (`@oh-my-pi/pi-catalog` 18.2.1, MIT License).
 * Upstream: packages/catalog/src/discovery/protobuf.ts
 * Copyright (c) 2025 Mario Zechner; 2025-2026 Can Bölük; 2026 Stencil Labs, Inc.
 * See LICENSE.oh-my-pi in this directory. Local changes: the upstream
 * `@oh-my-pi/pi-utils` import of `isRecord` is replaced by the local helper
 * below, and the Bun-only `Uint8Array.toBase64()` used by the bytes `toJson`
 * projection is replaced by the Node `Buffer` equivalent, so this file has no
 * external dependencies and no runtime-specific extensions.
 */

/** Non-array object guard: the semantics of upstream's `isRecord` helper. */
