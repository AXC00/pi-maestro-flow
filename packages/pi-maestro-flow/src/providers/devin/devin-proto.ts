...
/**
 * Devin (Codeium Cascade) protocol declarations.
 *
 ...
 * Upstream: packages/catalog/src/discovery/devin-proto.ts
 * Copyright (c) 2025 Mario Zechner; 2025-2026 Can Bölük; 2026 Stencil Labs, Inc.
 * See LICENSE.oh-my-pi in this directory. The only local change makes the
 * `./protobuf` import carry the explicit `.ts` extension this repository uses.
 */
